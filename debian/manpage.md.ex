% stipo.1.0(SECTION) | User Commands
%
% "October  2 2023"
...
stipo.1.0 - program to do something

# SYNOPSIS

**stipo.1.0** **-e** _this_ [**\-\-example=that**] [{**-e** | **\-\-example**} _this_]
                 [{**-e** | **\-\-example**} {_this_ | _that_}]

**stipo.1.0** [{**-h** | *\-\-help**} | {**-v** | **\-\-version**}]

# DESCRIPTION

This manual page documents briefly the **stipo.1.0** and **bar** commands.

This manual page was written for the Debian distribution because the
original program does not have a manual page. Instead, it has documentation
in the GNU info(1) format; see below.

**stipo.1.0** is a program that...
...
:   The system-wide configuration file to control the behaviour of
    stipo.1.0. See **foo.conf**(5) for further details.
...
**stipo.1.0** provides some return codes, that can be used in scripts:
...
Doston <hunter@doston.net>
:   Wrote this manpage for the Debian system.

# COPYRIGHT

Copyright © 2007 Doston
